"""Baixa a aba 'LS_BASE_JOGOS' da planilha do grupo e salva em data/base_jogos.csv.

Rodado manualmente (`python scripts/fetch_data.py`) ou pela GitHub Action
semanal em .github/workflows/update-data.yml. Sem dependencias do Streamlit
de proposito, para poder rodar em CI sem instalar o app inteiro.
"""
